...
return [
    ...
    */
    ...
    'app_name' => env('SHOPIFY_APP_NAME', 'Padre Colombia'),
    ...
    */
    ...
    'api_key' => env('SHOPIFY_API_KEY', 'c45c993ee04723a2f12b70d1f830af40'),
    ...
    */
    ...
    'api_secret' => env('SHOPIFY_API_SECRET', '41cd61fa0ea07c6f9c6ed965c558cc0a'),
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_products,write_products,read_themes,read_orders,read_customers,write_customers,write_script_tags'),
    ...
    */
    ...
    'webhooks' => [
        [
            ...
            'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS', 'https://d9eb-80-28-111-246.ngrok-free.app/webhook/app-uninstalled')
        ],
        /*
            [
    ...
    */
    ...
    // 'scripttags' => [
    //         [
    //             'src' => env('SHOPIFY_SCRIPTTAG_1_SRC', 'https://72b1-80-28-111-246.ngrok-free.app/some-controller/js-method-response'),
